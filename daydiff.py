...
ttk.Label(frame, text="End Date (DD-MM-YYYY):").grid(row=1, column=0, padx=5, pady=5, sticky="w")
...
# About Section
about_label = ttk.Label(root, text="Created by Ray C. Turner", font=("Arial", 8))
